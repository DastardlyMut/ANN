...
% %D([1:50],:)= feature values for i.setosa: class 1 =[1 0 0 ]'
% %D([51:100],:)= feature values for i.versicolor: class 2 = [0 1 0]'
% %D([101:150],:)= feature values for i.verginica: class 3 =[0 0 1]'
